...
public class TestCalculation {
	...
	private void discountInit(String[] filelist) {
		context = new Context();
		context.init(filelist);
	}

	@Test
	public void test1condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount1.xml", "src\\test\\resources\\invoice1.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromShop = new ArrayList<ArrayList<Product>>();
		responseFromShop = context.discountCalculate();
	...
	public void test2condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount2.xml", "src\\test\\resources\\invoice2.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromShop = new ArrayList<ArrayList<Product>>();
		responseFromShop = context.discountCalculate();
		Iterator<ArrayList<Product>> i = responseFromShop.iterator();
	...
	public void test3condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount3.xml", "src\\test\\resources\\invoice3.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromShop = new ArrayList<ArrayList<Product>>();
		responseFromShop = context.discountCalculate();
		Iterator<ArrayList<Product>> i = responseFromShop.iterator();
	...
	public void test4condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount4.xml", "src\\test\\resources\\invoice4.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromShop = new ArrayList<ArrayList<Product>>();
		responseFromShop = context.discountCalculate();
		Iterator<ArrayList<Product>> i = responseFromShop.iterator();
	...
	public void test5condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount5.xml", "src\\test\\resources\\invoice5.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromShop = new ArrayList<ArrayList<Product>>();
		responseFromShop = context.discountCalculate();
		Iterator<ArrayList<Product>> i = responseFromShop.iterator();
	...
	public void test6condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount6.xml", "src\\test\\resources\\invoice6.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromShop = new ArrayList<ArrayList<Product>>();
		responseFromShop = context.discountCalculate();
		Iterator<ArrayList<Product>> i = responseFromShop.iterator();
	...
	public void test7condition() {
		String[] arg = new String[] { "src\\test\\resources\\pricelist.xml", "src\\test\\resources\\discount7.xml", "src\\test\\resources\\invoice7.xml" };
		discountInit(arg);
		ArrayList<ArrayList<Product>> responseFromContext = new ArrayList<ArrayList<Product>>();
		responseFromContext = context.discountCalculate();
		Iterator<ArrayList<Product>> i = responseFromContext.iterator();
